...
4. Check `docs/PROJECT_ROOT.md` for current `{version}` (default `v1.0`). Ensure `docs/{version}/1-prds/` exists for PRD output
...
1. **Final PRD**: `docs/{version}/1-prds/PRD-{feature_name}.md`
