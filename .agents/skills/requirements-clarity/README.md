...
4. **PRD Generation** (Step 4)
   ...
   - Saves to `docs/{version}/1-prds/PRD-{feature-name}.md`
...
[Generates PRD at docs/v1.0/1-prds/PRD-user-authentication.md]

Your Product Requirements Document is ready!

File: docs/v1.0/1-prds/PRD-user-authentication.md
...
```
`docs/{version}/1-prds/PRD-{feature-name}.md`
```
