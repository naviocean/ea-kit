...
- **Output**: Professional yet concise PRDs saved to `docs/{version}/1-prds/PRD-{feature-name}.md`
...
Generating professional PRD at docs/{version}/1-prds/PRD-{feature-name}.md..."
```

Generate PRD using template below, then confirm:

```
"✅ PRD saved to docs/{version}/1-prds/PRD-{feature-name}.md
...
Save to: `docs/{version}/1-prds/PRD-{feature-name}.md`
...
- ✅ Save to `docs/{version}/1-prds/PRD-{feature-name}.md` with proper naming
